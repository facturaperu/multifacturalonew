                        ...
                        <tbody>
                            @foreach($reports as $key => $value)
                                <tr>
                                    ...
                                    <td class="celda">{{(in_array($value->document_type_id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? number_format(0,2) : number_format($value->total_taxed,2)}}</td>
                                    <td class="celda">{{(in_array($value->document_type_id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? number_format(0,2) : number_format($value->total_igv,2)}}</td>
                                    <td class="celda">{{(in_array($value->document_type_id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? number_format(0,2) : number_format($value->total,2)}}</td>
