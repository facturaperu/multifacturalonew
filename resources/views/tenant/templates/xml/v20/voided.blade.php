...
<VoidedDocuments xmlns="urn:sunat:names:specification:ubl:peru:schema:xsd:VoidedDocuments-1"
    ...
    <cbc:ReferenceDate>{{ $voided->date_of_reference->format('Y-m-d') }}</cbc:ReferenceDate>
    <cbc:IssueDate>{{ $voided->date_of_issue->format('Y-m-d') }}</cbc:IssueDate>
    <cac:Signature>
    ...
    @foreach($documents as $doc)
        ...
        <sac:VoidedDocumentsLine>
            ...
            <sac:VoidReasonDescription><![CDATA[{{ $document->voided_description }}]]></sac:VoidReasonDescription>
        </sac:VoidedDocumentsLine>
    @endforeach
</VoidedDocuments>