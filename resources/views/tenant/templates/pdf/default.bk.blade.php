    ...
    <tr>
        <td width="30%">
            <table class="voucher-company-left">
                <tbody>
                <tr><td class="text-left font-xxlg font-bold"><img src="{{ asset('storage/uploads/logos/'.$company->logo) }}" class="company_logo"></td></tr>
                </tbody>
            </table>
        </td>
        <td width="35%">
            <table class="voucher-company-left">
                ...
                {{-- <tr><td class="text-center font-xxlg font-bold"><img src="{{ asset($company->logo) }}" class="company_logo"></td></tr> --}}
                {{--@endif--}}
    ...
    <tr>
        <td width="60%">
            <table class="voucher-information-left">
                ...
                <tr><td width="20%">{{ $identity_document_type_description_array[$customer->identity_document_type->code] }}:</td><td width="70%">{{ $customer->number }}</td></tr>
                {{--@if (isset($customer->address))--}}
                @if($customer->identity_document_type->code === '6')
...
<table class="voucher-details">
    ...
    <tfoot>
        <tr>
            <td colspan="5" class="font-lg font-bold">Son: {{ $document->number_to_letter }} {{ $document->currency_type_code }}</td>
        </tr>
    </tfoot>
</table>
