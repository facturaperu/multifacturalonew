...
class SummaryInput
{
    public static function set($inputs)
    {
        ...
        if ($summary_status_type_id === '1') {
            $documents = Functions::findDocumentsBySummary($soap_type_id, $date_of_reference);
        } else {
            $documents = $inputs['documents'];
            $documents = Functions::verifyDocumentsByVoided($soap_type_id, $date_of_reference, $documents, Summary::class);
        }
